package com.app.bs1p.Menu.Kunjungan;
...
public class Pengujian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvInstal = findViewById(R.id.tvInstal);
        ...
        api.getKunjungan().enqueue(new Callback<ResponseKunjungan>() {
            ...
            public void onResponse(@NonNull Call<ResponseKunjungan> call, @NonNull Response<ResponseKunjungan> response) {
                ...
                String text = response.body().getKunjungan().getKunjunganInstalasiPengujian();
                tvInstal.setText(HtmlCompat.fromHtml(text, HtmlCompat.FROM_HTML_MODE_LEGACY));
            }
            @Override
